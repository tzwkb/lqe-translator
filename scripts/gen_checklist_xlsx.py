...
r += 1
ws.cell(row=r, column=1, value="应用状态：本清单尚未接入评估流程，当前为参考文档。已生效的仅有 projects/wwm/adjudications.md 中归档的 0512 裁决（评估前必读文件，下次评估自动注入）；其余新增内容均待批准实施，见“后续实施事项”").alignment = WRAP
r += 1
